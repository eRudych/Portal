...
public class StatusRecord extends UpdatableRecordImpl<StatusRecord> implements Record2<Long, String> {

    private static final long serialVersionUID = 1456083343;
    ...
    @Override
    public StatusRecord value1(Long value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public StatusRecord values(Long value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public StatusRecord(Long id, String name) {
        super(Status.STATUS);
