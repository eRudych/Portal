...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record6<Long, String, String, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = 113038506;
     ...
     */
    public UserRecord(Long id, String login, String password, String name, String nick, Timestamp createdAt) {
        super(User.USER);
